...
\item (This is a term I made up....)
\item We haven't covered inner products yet
\end{itemize}
\item Each entry of the resultant matrix is an inner product of a row of the first matrix and a column of the second matrix
...
\begin{itemize}
\item (Also a term I made up....heh...)
\item We \textit{have} covered linear combinations :)
\end{itemize}
